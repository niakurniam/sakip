  ...
  <>
      ...
      <div className="w-full max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto bg-white rounded-xl shadow-md p-4 sm:p-8">
        ...
        <p className="mb-6 text-justify text-sm sm:text-base text-gray-700 font-[Average_Sans]">
          <span><b>Nilai SAKIP</b></span> adalah dokumen yang memuat penugasan dan target kinerja tahunan yang disepakati antara pimpinan dan 
        ...
        <h2 className="text-lg sm:text-xl font-semibold text-[#0a4a8e] mb-3 sm:mb-4">
          Unduh Dokumen Nilai SAKIP PPNS
        </h2>
        <div className="flex flex-col gap-4">
          ...
          >
            ...
            <span>Nilai SAKIP PPNS 2024 (PDF)</span>
          </Link>
          <Link
          ...
          >
            <HiOutlineDocumentText className="text-2xl text-blue-500" />
            <span>Nilai SAKIP PPNS 2023 (PDF)</span>
          </Link>
          <Link
          ...
          >
            <HiOutlineDocumentText className="text-2xl text-blue-500" />
            <span>Nilai SAKIP PPNS 2022 (PDF)</span>
          </Link>
          <Link
          ...
          >
            <HiOutlineDocumentText className="text-2xl text-blue-500" />
            <span>Nilai SAKIP PPNS 2021 (PDF)</span>
          </Link>
        </div>
      </div>
    </div>

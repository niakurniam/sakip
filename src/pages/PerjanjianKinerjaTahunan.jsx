...
const PerjanjianKinerjaTahunan = () => (
  <>
      ...
      <div className="w-full max-w-2xl md:max-w-3xl lg:max-w-4xl mx-auto bg-white rounded-xl shadow-md p-4 sm:p-8">
        ...
        <p className="mb-6 text-justify text-sm sm:text-base text-gray-700 font-[Average_Sans]">
          <span><b>Perjanjian Kinerja Tahunan</b></span> adalah dokumen yang memuat penugasan dan target kinerja tahunan yang disepakati antara pimpinan dan 
...
export default PerjanjianKinerjaTahunan;